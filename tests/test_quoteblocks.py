...
def test_five_images_repeated():
    ...
    positions = [
        ...
        Position(line=24, offset=0, length=len_01),
        Position(line=35, offset=0, length=len_01),
        Position(line=46, offset=0, length=len_01),
        Position(line=57, offset=0, length=len_01)
    ]
