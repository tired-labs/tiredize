...
[![Run tests and upload coverage](https://github.com/tired-labs/tiredize/actions/workflows/ci.yaml/badge.svg?branch=main)](https://github.com/tired-labs/tiredize/actions/workflows/ci.yaml) [![codecov](https://codecov.io/github/tired-labs/tiredize/graph/badge.svg?token=MQGTYZOGV4)](https://codecov.io/github/tired-labs/tiredize)
